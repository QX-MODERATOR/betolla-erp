...
export const SYSTEM_ACCOUNTS = [
  ...
  {
    id: "mgr-mkt-01",
    usernames: ["ammar.mrk.mgr", "ammar.mgr", "marketing.mgr", "marketing_manager", "marketing_mgr@betolla.com"],
  ...
  {
    id: "rep-hanan-01",
    usernames: ["hanan.sales", "hanan", "hanan@betolla.com", "hanan@betollacosmetics.com"],
